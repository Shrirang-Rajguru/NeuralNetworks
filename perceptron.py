...
#Assigning bias and learning rate
bias = 0.3
lr = 0.05
...
#Derviative of Sigmoid Function
def derivative_sigmoid(x):
    return (sigmoid(x) * (1- sigmoid(x)))

#Initialising error and range for plotting
error = []
...
#Predicting single point values by the trainned perceptron
